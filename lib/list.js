...
var List = function (_React$Component) {
    ...
    function List(props) {
        ...
        var _getIndexByValue = (0, _util.getIndexByValue)(list, value, itemHeight),
    ...
    (0, _createClass3.default)(List, [{
        ...
        value: function componentDidMount() {
            ...
            this.refs.iscroll.withIScroll(true, function (iScroll) {
                ...
                var _height = itemHeight || _constant.ITEMHEIGHT;
                var scrollY = iScroll.y;
                var cur = Math.abs(Math.round(scrollY / _height)) + 3;
                var _value = list[cur];
                onSelect && onSelect({ value: _value, scope: scope, index: index, type: type });
            });
        }
    }, {
        ...
        value: function componentDidUpdate() {
            ...
            var _getIndexByValue2 = (0, _util.getIndexByValue)(list, value, itemHeight),
        ...
        value: function scrollEnd(iScrollInstance) {
            ...
            var _height = itemHeight || _constant.ITEMHEIGHT;
            var _halfHeight = itemHeight ? Math.round(itemHeight / 2) : _constant.HALFITEMHEIGHT;
            var spare = y % _height;
            var scrollY = y;
            if (spare != 0) {
