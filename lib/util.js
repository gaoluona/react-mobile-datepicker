...
//根据value找出数组中的位置
var getIndexByValue = exports.getIndexByValue = function getIndexByValue(list, value, itemH) {
    var curIndex = 3;
    ...
    var _height = itemH || _constant.ITEMHEIGHT;
    curIndex = curIndex < 3 ? 3 : curIndex;
    var startY = -(curIndex - 3) * _height;
    return {
        curIndex: curIndex,
        startY: startY
    };
